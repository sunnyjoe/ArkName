...
- (void)initView{
    ...
    //选中时显示的图片
    imgview = [[UIImageView alloc]initWithFrame:CGRectMake(9, 18, self.bounds.size.width - 18, self.bounds.size.width - 18)];
    ...
    day_lab.font = [UIFont systemFontOfSize:19];
...
- (void)setModel:(CalendarDayModel *)model
{
    ...
    switch (model.style) {
        ...
        case CellDayTypePast://过去的日期
            ...
            day_lab.textColor = COLOR_THEME;//[UIColor lightGrayColor];
